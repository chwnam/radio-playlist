 ...
 *
 * etc/class-rapl-script-helper.php
 */
...
if ( ! class_exists( 'RAPL_Script_Helper' ) ) {
	class RAPL_Script_Helper {
		/**
		 ...
		 * Constructor method.
		 *
		 * @param RAPL_Template_Impl|RAPL_Module $parent Parent object.
		 ...
		 * Finish call chain
		 *
		 * @return RAPL_Template_Impl|RAPL_Module
		 */
