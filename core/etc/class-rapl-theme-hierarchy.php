 ...
 *
 * etc/class-rapl-theme-hierarchy.php
 */
...
if ( ! class_exists( 'RAPL_Theme_Hierarchy' ) ) {
	final class RAPL_Theme_Hierarchy {
		...
		/** @var RAPL_Front_Module|string|false|null */
		private $front_module = null;

		private static ?RAPL_Theme_Hierarchy $instance = null;

		/**
		 * Get the instance.
		 *
		 * @return RAPL_Theme_Hierarchy
		 */
		public static function get_instance(): RAPL_Theme_Hierarchy {
		...
		private function __construct() {
			...
			do_action_ref_array( 'rapl_theme_hierarchy', [ &$this ] );
		}

		/**
		 * Get front module.
		 *
		 * @return RAPL_Front_Module|string|null
		 */
		 ...
		 * Set front module.
		 *
		 * @param RAPL_Front_Module|string $module Front module instance, or class name
		 *
		 * @return void
		 */
		public function set_front_module( $module ) {
			if ( is_string( $module ) ) {
				$instance = rapl_parse_module( $module );
				if ( $instance ) {
		...
		public function get_fallback(): RAPL_Front_Fallback {
			return new RAPL_Front_Fallback();
		}
