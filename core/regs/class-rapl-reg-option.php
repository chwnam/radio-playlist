 ...
 *
 * regs/class-rapl-reg-option.php
 */
...
if ( ! class_exists( 'RAPL_Reg_Option' ) ) {
	/**
	 ...
	 */
	class RAPL_Reg_Option implements RAPL_Reg {
		...
		public static function factory( string $option_name ): ?RAPL_Reg_Option {
			...
			if ( isset( $wp_registered_settings[ $option_name ] ) ) {
				if ( ! isset( static::$options[ $option_name ] ) ) {
					...
					static::$options[ $option_name ] = new RAPL_Reg_Option( $args['group'], $option_name, $args );
				}
