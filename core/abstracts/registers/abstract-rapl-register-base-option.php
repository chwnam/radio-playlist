 ...
 *
 * abstracts/registers/abstract-rapl-register-base-option.php
 */
...
if ( ! class_exists( 'RAPL_Register_Base_Option' ) ) {
	abstract class RAPL_Register_Base_Option implements RAPL_Register {
		use RAPL_Hook_Impl;

		/**
		 * Registered fields.
		 *
		 * @var array{string: RAPL_Reg_Option}
		 */
		...
		public function __get( string $alias ): ?RAPL_Reg_Option {
			if ( isset( $this->fields[ $alias ] ) ) {
				return RAPL_Reg_Option::factory( $this->fields[ $alias ] );
			}
