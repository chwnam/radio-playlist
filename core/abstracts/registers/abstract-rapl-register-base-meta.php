 ...
 *
 * abstracts/registers/abstract-rapl-register-base-meta.php
 */
...
if ( ! class_exists( 'RAPL_Register_Base_Meta' ) ) {
	abstract class RAPL_Register_Base_Meta implements RAPL_Register {
		use RAPL_Hook_Impl;
		...
		public function __get( string $alias ): ?RAPL_Reg_Meta {
			if ( isset( $this->fields[ $alias ] ) ) {
				return RAPL_Reg_Meta::factory( ...$this->fields[ $alias ] );
			}
