...
if ( ! class_exists( 'RAPL_CLI_Node_Visitor_Const' ) ) {
	class RAPL_CLI_Node_Visitor_Const extends NodeVisitorAbstract implements RAPL_CLI_Node_Visitor {
		...
		private function extract_from_node( Node $node ): void {
			if (
				...
				$this->tokens[] = new RAPL_CLI_Token_Const(
					new RAPL_CLI_Token(
