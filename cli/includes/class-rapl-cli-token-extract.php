...
if ( ! class_exists( 'RAPL_CLI_Token_Extract' ) ) {
	class RAPL_CLI_Token_Extract {
		private Parser $parser;

		/** @var Node[]|null $nodes */
		private array|null $nodes;

		private RAPL_CLI_Node_Visitor $visitor;

		private NodeTraverser $traverser;

		public function __construct( RAPL_CLI_Node_Visitor $visitor ) {
